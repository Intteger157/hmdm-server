...
public interface ServerService {
    ...
    @POST("{project}/rest/plugins/deviceremote/public/launch/{number}")
    @Headers("Content-Type: application/json")
    Call<ResponseBody> confirmRemoteControlLaunch(@Path("project") String project, @Path("number") String number, @Body DeviceInfo deviceInfo);

    @POST("{project}/rest/plugins/deviceremote/public/stop/{number}")
    @Headers("Content-Type: application/json")
    Call<ResponseBody> confirmRemoteControlStop(@Path("project") String project, @Path("number") String number, @Body DeviceInfo deviceInfo);
