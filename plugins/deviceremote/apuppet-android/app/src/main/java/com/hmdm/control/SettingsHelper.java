...
public class SettingsHelper {
    ...
    public static final String KEY_MDM_DEVICE_NUMBER = "mdm_device_number";
    public static final String KEY_MDM_SERVER_URL = "mdm_server_url";
    public static final String KEY_MDM_SERVER_PROJECT = "mdm_server_project";
